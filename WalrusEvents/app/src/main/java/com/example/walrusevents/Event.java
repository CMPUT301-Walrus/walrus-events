...
public class Event {
     ...
     * This class and EventController was fed in and asked it to make a function to concatenate the attributes
     * 11/03/26
     * @return string of the description for the event
     */
    public String generateDefaultDescription() {
        ...
        if (entrantCapacity > 0) {
            sb.append("Capacity: ").append(entrantCapacity).append(" entrants\n");
        } else {
            sb.append("Capacity: Open (No limit)\n");
        }

        if (startRegistrationTime != null) {
            // You can format this more nicely later, but this works for now!
            sb.append("Registration opens: ").append(startRegistrationTime.toLocalDate());
        }
